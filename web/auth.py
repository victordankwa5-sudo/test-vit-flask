...
from .models import User, Cart, Payment, Order, Product
...
def checkout():
    ...
    if payment_status:
        ...
        return render_template('checkout.html', user=current_user, cart_detail=cart_detail,amount=amount, total=total)
    else:
